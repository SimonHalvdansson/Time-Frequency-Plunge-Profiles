...
%compute eigenvalues and erfc
eigenvalues = real(framemuleigs(Fa, Fs, s, a * M));
...
%plot eigenvalues
plot(k, eigenvalues, '-', 'LineWidth', 1.5, 'DisplayName', '$\lambda_k^\Omega$');
hold on;
...
plot(k, eigenvalues - erfc_values.', '-x', 'LineWidth', 1, 'Color', 'm', 'DisplayName', 'Error');
